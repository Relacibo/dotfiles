...
CONFIG="${SFTPGO_SHARE_CONFIG:-}"
if [ -z "$CONFIG" ]; then
  if [ -f "$HOME/.config/antigravity-skill-typst/share.env" ]; then
    CONFIG="$HOME/.config/antigravity-skill-typst/share.env"
  elif [ -f "$HOME/.config/opencode-skill-typst/share.env" ]; then
    CONFIG="$HOME/.config/opencode-skill-typst/share.env"
  else
    CONFIG="$HOME/.config/claude-skill-typst/share.env"
  fi
fi
if [ ! -f "$CONFIG" ]; then
